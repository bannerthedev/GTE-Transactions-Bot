...
# channels
# channels
TRANSACTIONS_ID = 1508715988647153858
MATCH_TIMES_CHANNEL_ID = 1508716330524872834
ASSIGNMENTS_CHANNEL_ID = 1508716301298962502
SCRIM_CATEGORY_ID = 0  # put your Scheduling category ID here, or 0 to create/use none
MATCH_SCORES_CHANNEL_ID = 1508716044322340935  # put your match-score channel ID here

# staff/team roles
CAPTAIN_ROLE_ID = 1509267029201522779
CO_CAPTAIN_ROLE_ID = 1509267047043825664
EXECUTIVE_ROLE_ID = 1509267009370853518
TEAM_PLAYER_ROLE_ID = 1509267069869363220

# assignment roles
HEAD_REF_ROLE_ID = 1509266285668597942
REF_ROLE_ID = 1509266302219321394
HEAD_CASTER_ROLE_ID = 1509266261937361006
CASTER_ROLE_ID = 1509266247190057142

FAQ_CHANNEL_ID = 1508713902026919936  # replace with the channel ID where FAQ should be posted
STREAM_WATCHER_ROLE_ID = 1508548137894023349  # 🎥 Stream Watcher
UNBORN_CAPTAIN_ROLE_ID = 1508548191753343177  # 🚀 Unborn Captain
EVENT_PING_ROLE_ID = 1508548173864505404     # 🎉 Event Ping
...
async def info(interaction: discord.Interaction):
    embed = discord.Embed(
        title="GTE Transactions Bot – Command Guide",
    ...
    embed.add_field(
        ...
        value="Change the team's captain (COMMING SOON e.g. banner1234 to .celestially.).",
        inline=False,
    )
    embed.add_field(
...
async def admin_info(interaction: discord.Interaction):
    ...
    embed = discord.Embed(
        title="GTE Transactions Bot – Admin Command Guide",
...
@bot.tree.command(
    guild=GUILD_OBJ,
    name="faq",
    description="Post the GTE FAQ and auto-role buttons (admins only)."
)
async def faq(interaction: discord.Interaction):
    ...
    text = (
        "# Gorilla Tag Elite Frequently Asked Questions\n\n"
        ...
        "## • Application Forms\n\n"
        "> - GTE has a various list of positions and applications to better help the league!,\n"
